...
import { Home, Info, Sparkles, Activity, MessageCircle } from "lucide-react";

const navItems = [
  { name: "Home", href: "/", icon: Home },
  { name: "About", href: "/#about", icon: Info },
  { name: "Services", href: "/#services", icon: Sparkles },
  { name: "Results", href: "/success-stories", icon: Activity },
          ...
          <div className="flex items-center gap-1.5 md:gap-2">
            ...
            >
              <svg className="w-3.5 h-3.5 md:w-4 md:h-4 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.02 1.59 4.19 1.13 1.25 2.69 1.93 4.3 2.02v3.74c-1.6-.08-3.18-.65-4.46-1.67-.7-.56-1.28-1.28-1.68-2.1-.06 1.93-.03 3.86-.04 5.79-.04 2.1-.47 4.22-1.62 5.92-1.4 2.1-3.9 3.4-6.4 3.46-2.5.07-5.06-1.02-6.52-3.04-1.6-2.22-1.84-5.46-.58-7.91 1.03-2.02 3.12-3.4 5.38-3.6 1.05-.1 2.13.04 3.13.43-.01 1.4-.01 2.8-.02 4.2-.6-.27-1.25-.4-1.92-.37-1.4.07-2.73.93-3.32 2.21-.68 1.43-.44 3.25.6 4.41.97 1.1 2.5 1.5 3.9 1.08 1.26-.37 2.22-1.46 2.45-2.77.06-.55.03-1.1.04-1.65.01-4.22.01-8.44.02-12.66z"/>
              </svg>
            </a>
          </div>
